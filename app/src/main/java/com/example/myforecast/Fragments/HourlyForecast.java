...
public class HourlyForecast extends Fragment {
    ...
    private ArrayList<ForecastModel> testList = new ArrayList<>();
    ...
    private void setup(){
        ...
        viewModel.getForecastData(latitude, longitude).observe(getViewLifecycleOwner(), new Observer<List<ForecastModel>>() {
            ...
            public void onChanged(List<ForecastModel> forecastModels) {
                ...
                System.out.println(testList.get(0).getCurrent().getDateTime());
                System.out.println(testList.get(0).getHourlyForecast().get(0).getDateTime());
                System.out.println(testList.get(0).getDailyForecast().get(0).getDateTime());
            }
        });
